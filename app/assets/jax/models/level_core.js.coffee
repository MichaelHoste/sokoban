...
class window.LevelCore
  ...
  # Constructor
  constructor: (pack_name, level_name) ->
    @pack_name = pack_name     # Name of pack that contains this level
    @level_name = level_name   # Name of this level
