  ...
  window.DeadlockCore = (function() {
    ...
    */
    ...
    DeadlockCore.prototype.create_corner_deadlock_positions = function(level) {
      var deadlock_positions, m, n, pos, _i, _j, _ref, _ref1;
      deadlock_positions = [];
      for (m = _i = 0, _ref = level.rows_number - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; m = 0 <= _ref ? ++_i : --_i) {
        for (n = _j = 0, _ref1 = level.cols_number - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; n = 0 <= _ref1 ? ++_j : --_j) {
    ...
    */
    ...
    DeadlockCore.prototype.deadlocked_last_push = function(level, box_position, deadlocked_positions) {
      ...
      */
      ...
      var cell, deadlock, pos, still_deadlocked, _i, _j, _k, _len, _len1, _len2, _ref;
      pos = {
        box: box_position,
        left: {
          m: box_position.m,
      ...
      */
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = deadlock.length; _j < _len1; _j++) {
          pos = deadlock[_j];
        ...
        if (still_deadlocked) {
          for (_k = 0, _len2 = deadlock.length; _k < _len2; _k++) {
            pos = deadlock[_k];
            cell = level.read_pos(pos.m, pos.n);
