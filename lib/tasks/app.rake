...
def compile_coffee_to_js
  ...
  `rm -f lib/assets/deadlock_core.js lib/assets/deadlock_core.js.js`
  ...
  `coffee --compile --output lib/assets/ app/assets/jax/models/deadlock_core.js.coffee`
  
  `mv lib/assets/level_core.js.js lib/assets/level_core.js`
  `mv lib/assets/path_core.js.js lib/assets/path_core.js`
  `mv lib/assets/deadlock_core.js.js lib/assets/deadlock_core.js`
